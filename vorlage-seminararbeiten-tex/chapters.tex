...
{weather="locationId=home, type=wind, property=speed"}
		...
		Das Item File der Wetter Items aus Abbildung \ref{lst:code-weatheritems} erzeugt drei Items welche die Temperatur, die Niederschlagswahrscheinlichkeit und die Windgeschwindigkeit beinhalten.
