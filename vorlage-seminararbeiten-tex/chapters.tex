...
\begin{itemize}
	\item 	per Web-Oberfläche per Button click in der Inbox, nachdem das entsprechende Binding installiert wurde. 
		\centering
		\captionsetup{type=figure}
		\includegraphics[width=1\textwidth]{\figdir/thing_add.png}
		\caption{Thing per Oberfläche \label{fig:verteilungs-architektur}}
