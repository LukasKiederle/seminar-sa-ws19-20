...
{weather="locationId=home, type=wind, property=speed"}
	...
	\end{minipage}
		...
		\smallskip
		Abbildung \ref{fig:activity-diagram} zeigt ein erstelltest Panel. Im Detail ist links Oben der Namen des Dashboardes "`Home"' und darunter die aktuelle Uhrzeit zu sehen. Letzteres ist ein Standard-Widget von openHAB.
