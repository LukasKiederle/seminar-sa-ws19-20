...
In diesem Kapitel wird das open-source Projekt OpenHAB untersucht und bewertet. Die Kriterien hierfür sind orientiert an der QAware Open Source Quick-Check Liste.
Dies beinhaltet:
\begin{longtable}{| p{3cm} | p{12cm}|}
	...
	\label{table:openhub-judgment-kriteria}
\end{longtable}
Das Projekt OpenHAB befindet sich auf Github unter \url{https://github.com/openhab/openhab-core}. 
