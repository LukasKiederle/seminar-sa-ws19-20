...
Number   Wind_Speed           "Windspeed [%.2f km/h]"    {weather="locationId=home, type=wind, property=speed"}
	...
	\end{minipage}
		...
		In myOpenHab können erstellte Dashboards angezeigt werden mit denen das Gerät wie gewohnt gesteuert werden kann.
		Es gibt für die myOpenHab Cloud auch Smartphone Apps für Android und iOS. Nach der Anmeldung mit dem myOpenHab Account ist ein sichere Zugriff auf das System auch von unterwegs möglich.
