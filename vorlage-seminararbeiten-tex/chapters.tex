...
\begin{itemize}
	\item 	per Web-Oberfläche per Button click in der Inbox, nachdem das entsprechende Binding installiert wurde. \includegraphics[width=1\textwidth]{\figdir/thing_add.png}
	\item 
\end{itemize}
