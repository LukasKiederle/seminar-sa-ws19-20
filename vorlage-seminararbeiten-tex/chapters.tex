...
{weather="locationId=home, type=wind, property=speed"}
		...
		Die Item-Datei der Wetter Items aus Codebeispiel \ref{} erzeugt drei Items welche die Temperatur, die Niederschlagswahrscheinlichkeit und die Windgeschwindigkeit beinhalten.
