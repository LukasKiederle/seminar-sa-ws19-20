...
\begin{longtable}{| p{3cm} | p{10cm}| c |}
	...
	\end{itemize} & \cmark\\
	\hline
	\centering Reifegrad & Existiert eine stabile Version > 1.0? & \cmark \\
	\hline
	\centering Lizenz & Für welche Zwecke kann das Projekt genutzt werden? & \cmark \\
	\hline
	\centering Support & Existiert Issue-Tracking und ein Antwortzeit auf Tickets unter 24h? & \cmark \\
	\hline
	\centering Dokumentation & Existiert?
	\begin{itemize}
		\item Api-Dokumentation
...
OpenHAB wurde bereits in der Bachelorarbeit von Pirmin Gersbacher vom Jahr 2017/2018 anhand von Usecases untersucht und verglichen. Dabei kam er zu folgender Ergebnistabelle \ref{fig:comparison-openhab}\cite{BA01:OPH}.
...
\begin{longtable}{| p{2cm} | p{13cm}|}
	...
	\hline
	\centering Channels & Übertragungskanal zwischen "`Dingen"' und "`Gegenständen"'. \\
	\hline
	\centering Items & von openHAB (Software) generierte Darstellung von Informationen über die Geräte.\\
	\hline
	\centering Link & Verbindung zwischen Things und Items \\
	\hline
